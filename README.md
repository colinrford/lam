...
- root-finding interoperability between `lam.ctbignum` and `polynomial_nttp`, try at your own risk! for now :)

Soon to join is [`linearalgebra`](https://www.github.com/colinrford/linearalgebra).
